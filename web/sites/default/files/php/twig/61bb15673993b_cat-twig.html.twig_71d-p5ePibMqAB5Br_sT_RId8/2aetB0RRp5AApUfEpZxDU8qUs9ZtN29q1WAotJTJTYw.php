...
<div class=\"cats-table-rows\">";
  ...
  <caption>";
        // line 3
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["caption"] ?? null), 3, $this->source), "html", null, true);
        echo "</caption>
</div>

<div class=\"cats-image_wrapper\">";
        // line 6
...
";
    ...
    {
        return array (  54 => 6,  48 => 3,  44 => 2,  39 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("<div class=\"cats-form_wrapper\">{{ form }}</div>
<div class=\"cats-table-rows\">{{ table }}
  <caption>{{ caption }}</caption>
</div>

<div class=\"cats-image_wrapper\">{{ image}}</div>
